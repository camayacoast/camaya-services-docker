...
function ActivityLogs(props) {
    ...
    const activityLogs = SalesAdminPortalService.activityLogs(props.reservation_number);
    ...
    return (
        <>
            <Button size={(typeof props.size !== 'undefined') ? props.size : 'middle'} type="default" onClick={() => showAcitivityLogsModal()}>Activity Logs</Button>
            <Modal
