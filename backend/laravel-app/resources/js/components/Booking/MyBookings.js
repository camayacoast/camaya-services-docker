...
export default function Page(props) {
    ...
    const [myBookingsFiltered, setMyBookingsFiltered] = React.useState();
    const myBookingsQuery = BookingService.myBookings();
    ...
    const handleTableChange = (pagination, filters, sorter, table) => {
        ...
        // setMyBookingsFiltered(
        //     _.filter(myBookingsQuery.data, item => _.includes(filters.status, item.status))
        // ); 
    ...
    return (
        <>
            <Row gutter={[12, 12]}>
                <Col xl={24}>
                    <Typography.Title level={4} className="my-4">My Bookings</Typography.Title>
                    <Table 
                        ...
                        dataSource={myBookingsQuery.data ? myBookingsQuery.data : []}
