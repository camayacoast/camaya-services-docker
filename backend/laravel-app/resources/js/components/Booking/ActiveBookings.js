...
export default function Page(props) {
    ...
    const bookingsQuery = BookingService.list('active', props.isTripping || false);

    // console.log(props.isTripping);
    ...
    const columns = [
        ...
        },
        {
            title: 'Customer',
            dataIndex: 'customer',
            // filters: _.map(bookingsQuery.data, b => {
            //     return {
            //         text: `${b.customer.first_name} ${b.customer.last_name}`,
            //         value: b.customer.id,
            //     }
            // }),
    ...
    return (
        <>
            <Row gutter={[12, 12]}>
                <Col xl={24}>
                    <Typography.Title level={4} className="my-4">Active Bookings</Typography.Title>
                    <Table 
