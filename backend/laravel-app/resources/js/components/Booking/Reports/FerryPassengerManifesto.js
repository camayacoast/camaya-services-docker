...
function Page(props) {
    ...
    const reportQuery = TranportationReportService.ferryPassengersManifestoBPO;
    const downloadReport = TranportationReportService.ferryPassengersManifestoDownloadBPO;
    ...
    return (
        <>
            <Typography.Title level={4}>Ferry Passengers Manifesto BPO</Typography.Title>
