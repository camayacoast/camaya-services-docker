...
import Icon, { MenuUnfoldOutlined, MenuFoldOutlined, TeamOutlined, LogoutOutlined, HomeOutlined, ArrowLeftOutlined, FileTextOutlined, BookOutlined, LikeOutlined, DashboardOutlined, UserOutlined, SettingOutlined } from '@ant-design/icons'
            ...
            >
                <div style={{display: 'flex', justifyContent:'space-between', alignItems:'center', flexDirection:'column', height: '100%'}}>
                    ...
                    <Menu
                        theme="dark"
                        mode="inline"
                        defaultSelectedKeys={['/concierge']}
                        selectedKeys={[selectedMenu]}
                    >
                        <Menu.Item key="/" icon={<ArrowLeftOutlined />}>
                            <NavLink to="/">Back to Main</NavLink>
                        </Menu.Item>
                        <Menu.Item key="/concierge" icon={<DashboardOutlined />}>
                            <NavLink to="/concierge">Dashboard</NavLink>
                        </Menu.Item>
                        <Menu.Item key="/concierge/reports" icon={<FileTextOutlined />}>
                            <NavLink to="/concierge/reports">Reports</NavLink>
                        </Menu.Item>
                    </Menu>
