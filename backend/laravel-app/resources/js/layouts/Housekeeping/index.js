...
import Icon, { MenuUnfoldOutlined, MenuFoldOutlined, LogoutOutlined, ArrowLeftOutlined, BookOutlined, DashboardOutlined, UserOutlined } from '@ant-design/icons'
            ...
            >
                <div style={{display: 'flex', justifyContent:'space-between', alignItems:'center', flexDirection:'column', height: '100%'}}>
                    ...
                    >
                        ...
                        <Menu.Item key="/housekeeping" icon={<DashboardOutlined />}>
                            <NavLink to="/housekeeping">Dashboard</NavLink>
                        </Menu.Item>
                    </Menu>
