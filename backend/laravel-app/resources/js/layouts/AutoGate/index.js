...
import Icon, { MenuUnfoldOutlined, MenuFoldOutlined, TeamOutlined, LogoutOutlined, HomeOutlined, ArrowLeftOutlined, FileTextOutlined, BookOutlined, LikeOutlined, DashboardOutlined, UserOutlined, SettingOutlined, CarOutlined } from '@ant-design/icons'
const { Content, Header, Sider } = Layout;


function AutoGate(props) {
            ...
            >
                <div style={{display: 'flex', justifyContent:'space-between', alignItems:'center', flexDirection:'column', height: '100%'}}>
                    ...
                    <Menu
                        theme="dark"
                        mode="inline"
                        defaultSelectedKeys={['/auto-gate']}
                        selectedKeys={[selectedMenu]}
                    >
                        <Menu.Item key="/" icon={<ArrowLeftOutlined />}>
                            <NavLink to="/">Back to Main</NavLink>
                        </Menu.Item>
                        <Menu.Item key="/auto-gate" icon={<DashboardOutlined />}>
                            <NavLink to="/auto-gate">Dashboard</NavLink>
                        </Menu.Item>
                        <Menu.Item key="/auto-gate/af-parking-monitoring" icon={<CarOutlined />}>
                            <NavLink to="/auto-gate/af-parking-monitoring">AF Parking Monitoring</NavLink>
                        </Menu.Item>
                    </Menu>
...
export default connect(mapStateToProps)(withRouter(AutoGate))
