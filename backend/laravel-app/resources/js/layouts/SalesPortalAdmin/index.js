...
import Icon, { MenuUnfoldOutlined, MenuFoldOutlined, TeamOutlined, LogoutOutlined, HomeOutlined, ArrowLeftOutlined, FileTextOutlined, BookOutlined, LikeOutlined, DashboardOutlined, UserOutlined, SettingOutlined, FieldTimeOutlined, FilePptOutlined } from '@ant-design/icons'
const { Content, Header, Sider } = Layout;

import CamayaSunIcon from 'assets/camaya-sun-icon.svg'


function SalesPortalAdmin(props) {
                ...
                <div style={{display: 'flex', justifyContent:'space-between', flexDirection:'column', height: '100%'}}>
                    <div>
                        ...
                        >
                            ...
                            <Menu.Item key="/sales-admin-portal/reservation-documents" icon={<FileTextOutlined />}>
                                <NavLink to="/sales-admin-portal/reservation-documents">Reservation Documents</NavLink>
                            </Menu.Item>

                            <Menu.Item key="/sales-admin-portal/sales-clients" icon={<UserOutlined />}>
                                <NavLink to="/sales-admin-portal/sales-clients">Sales Clients</NavLink>
                            </Menu.Item>

                            <Menu.Item key="/sales-admin-portal/promos" icon={<FilePptOutlined />}>
                                <NavLink to="/sales-admin-portal/promos">Promos</NavLink>
                            </Menu.Item>

                            <Menu.Item key="/sales-admin-portal/lot-inventory">
                                <NavLink to="/sales-admin-portal/lot-inventory">Lot Inventory</NavLink>
                            </Menu.Item>

                            <Menu.Item key="/sales-admin-portal/condo-inventory">
                                <NavLink to="/sales-admin-portal/condo-inventory">Condominium Inventory</NavLink>
                            </Menu.Item>

                            <Menu.Item key="/sales-admin-portal/sales-team" icon={<TeamOutlined />}>
                                <NavLink to="/sales-admin-portal/sales-team">Sales Team</NavLink>
                            </Menu.Item>
...
export default connect(mapStateToProps)(withRouter(SalesPortalAdmin))
