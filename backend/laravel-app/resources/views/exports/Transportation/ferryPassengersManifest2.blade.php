<table>
    <thead>
        <tr>
            <th colspan="15" height="50">
                {{-- <img src="images/magic-leaf-logo.png" width="140" /> --}}
            </th>
        </tr>
        <tr>
            <th colspan="15" align="center" style="font-size: 16pt; font-weight: bold; border: solid 3px black;">PASSENGER MANIFEST</th>
        </tr>
        <tr>
            <th colspan="15"><!--spacer--></th>
        </tr>
        <tr>
            <th colspan="15" style="font-size: 14pt; font-weight: bold;">Trip Information</th>
        </tr>
        <tr>
            <th colspan="15">Origin: {{$schedule->route->origin->name}}</th>            
        </tr>
        <tr>
            <th colspan="15">Destination: {{$schedule->route->destination->name}}</th>
        </tr>
        <tr>
            <th colspan="15"><!--spacer--></th>
        </tr>
        <tr>
            <th colspan="15" style="font-size: 14pt; font-weight: bold;">Schedule Information</th>
        </tr>
        <tr>
            <th colspan="15">Date: {{$schedule->trip_date}}</th>
        </tr>
        <tr>
            <th colspan="15">Departure: {{date('H:i', strtotime($schedule->start_time))}}</th>
        </tr>
        <tr>
            <th colspan="15">Arrival: {{date('H:i', strtotime($schedule->end_time))}}</th>
        </tr>
        <tr>
            <th colspan="15">Vessel: {{$schedule->transportation->name}}</th>
        </tr>        
        <tr>
            <th colspan="15"><!--spacer--></th>
        </tr>
    ...
    <tbody>                
        @if (count($status) === 1 && $status[0] === 'arriving')
            ...
            <tr>
                <th colspan="8" align="center" valign="middle" style="font-weight: bold;">
                    Booking Status
                </th>
        ...
        @else
            ...
            <tr>
                ...
                <th align="center" style="font-weight: bold;">Primary Customer</th>
            ...
            <tr>
                ...
                <td align="center">{{ $trip_booking->booking->customer->first_name }} {{ $trip_booking->booking->customer->last_name }}</td>
                ...
                <td align="center">{{ $trip_booking->booking->customer->email }}</td>
            ...
            @endif
            <tr>
                <th colspan="14"><!--spacer--></th>
            </tr>
            <tr>
                <th colspan="14" align="right" valign="middle" style="font-weight: bold;">
                    Total Bookings:                
                </th>
                <th>
                {{
