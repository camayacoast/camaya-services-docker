...
class FerryPassengersTransportationManifest implements FromView, WithColumnWidths, ShouldAutoSize, WithDrawings
{
    ...
    public function view(): View
    {
        ...
        return view('exports.Transportation.ferryPassengersManifest', [
            'schedule' => $schedule,
