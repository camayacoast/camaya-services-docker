...
namespace App\Exports\Transportation;
...
class FerryPassengersTransportationManifestoConcierge implements FromView, WithColumnWidths, ShouldAutoSize, WithDrawings
{
    ...
    public function view(): View
    {
        ...
        return view('exports.Transportation.ferryPassengersManifestConcierge', [
            'schedule' => $schedule,
