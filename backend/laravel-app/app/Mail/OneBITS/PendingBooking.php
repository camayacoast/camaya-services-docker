...
class PendingBooking extends Mailable
{
    ...
    public function build()
    {
        ...
        $booking_confirmation_pdf = PDF::loadView('pdf.onebits.pending_booking', ['reference_number' => $this->reference_number, 'tickets' => $this->tickets, 'booking'=>$booking]);
        $this->subject('Pending Booking | Booking ref #:'. $this->reference_number)
        ->from('booking@1bataanits.ph', '1BITS')
        ...
        ->markdown('emails.onebits.pending_booking');
