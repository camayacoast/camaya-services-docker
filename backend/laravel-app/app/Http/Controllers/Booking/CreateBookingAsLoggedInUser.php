...
class CreateBookingAsLoggedInUser extends Controller
{
    ...
    public function __invoke(CreateBookingAsLoggedInUserRequest $request)
    {
        ...
        $newBooking = Booking::create([
            ...
            'mode_of_transportation' => isset($request->guest_vehicles) ? 'own_vehicle' : ($request->mode_of_transportation),
            'eta' => $request->eta,
        ...
        $mailToSend = new NewBooking($booking, $camaya_transportations);
        ...
        if (
            ...
            if ($request->mode_of_transportation != 'van_rental') {
                ...
                $mailToSend = new BookingConfirmation($booking, $camaya_transportations);
            }
        }
