...
class AddFerryToBooking extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        $booking->load(['guests' => function ($query) {
        ...
        foreach ($guests as $key => $guest) {
            ...
            if ($request->first_trip) { 
                ...
                if ($infant_count > 0 || $kid_count > 0 || $adult_count > 0) {
                    ...
                    $first_trip = SeatSegment::where('id', $request->first_trip['id'])->select('trip_number')->first();
                    ...
                    if ($request->second_trip) {
                        ...
                        $second_trip = SeatSegment::where('id', $request->second_trip['id'])->select('trip_number')->first();
            ...
            foreach ($guests as $guest) {
                ...
                $newTrip_1 = Trip::create([
                    ...
                    'seat_number' => ($guest['age'] <= $infant_max_age) ? $seat_1->number : null,
                ...
                if ($request->second_trip && $request->trip_type == 'roundtrip') {
