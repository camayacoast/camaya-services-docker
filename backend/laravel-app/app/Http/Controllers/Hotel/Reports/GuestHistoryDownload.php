...
class GuestHistoryDownload extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        $bookings = \App\Models\Booking\Booking::whereNotIn('bookings.status', ['draft'])
            ...
            return \Maatwebsite\Excel\Facades\Excel::download(new ReportExport('reports.hotel.guest-history', $bookings->get()), 'report.xlsx');
    }
}
