...
function Page(props) {
    ...
    const reportQuery = HotelReportService.stayOverGuestList(formattedDate.format('YYYY-MM-DD'), properties);
    const downloadReport = HotelReportService.stayOverGuestListDownload;
    ...
    return (
        <>
            <Typography.Title level={4}>Stay-Over Guest List</Typography.Title>
            ...
            <Table
                ...
                columns={columns}
                dataSource={reportQuery?.data?.stayOver_guests || []}
                rowKey="id"
