...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="wrapper">
        ...
        <div>
            ...
            <p>No pre-payment available and all payment will be made at the terminal through cash payment only.</p>
        ...
        <!-- <div>
            ...
            <ul>
                <li>Customers may send an email Refund request to <strong>info@magicleaf.ph</strong> using the registered email address of the transaction. </li>
