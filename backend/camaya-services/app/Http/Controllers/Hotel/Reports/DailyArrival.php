...
class DailyArrival extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        ->orderBy('booking_reference_number', 'ASC');
        ...
        return [
            ...
            'stayover_room_total' => $stayover_room_total,
            'stayover_pax_total' => $stayover_pax_total,
            'houseuse_room_total' => $houseuse_room_total,
            'houseuse_pax_total' => $houseuse_pax_total,
        ];
    }
}
