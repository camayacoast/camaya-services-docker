...
class BankPayment extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Camaya Golf Payment Pending: '.$this->transactions[0]->transaction_id)
                    ->from('online.payment@camayacoast.com', 'Camaya Golf Payment')
